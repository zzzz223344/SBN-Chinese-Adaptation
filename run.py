...
def train(args):
    ...
    model_path = args.model_dir +args.dataset +'_'+ str(0.6111111111111112) + '.pt'
    if args.muti_gpu:
...
def main():
    ...
    parser.add_argument("--dataset_path", default="./datasets/ASTE-Data-V2-EMNLP2020/",
                        help="")
    parser.add_argument("--dataset", default="lap14", type=str, choices=["lap14", "res14", "res15", "res16", "405.Chinese_Zhang"],
